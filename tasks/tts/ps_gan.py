...
from modules.tts.portaspeech.multi_window_disc import Discriminator
...
class PortaSpeechGanTask(FastSpeechTask):
    def __init__(self):
        super().__init__()
    ...
    def run_model(self, sample, infer=False, *args, **kwargs):
        ...
        if not infer:
            ...
            if hparams['dur_level'] == 'word':
                ...
                super(PortaSpeechGanTask, self).add_dur_loss(output['dur'], sample['mel2ph'], sample['txt_tokens'], losses)
    ...
    def save_valid_result(self, sample, batch_idx, model_out):
        super(PortaSpeechGanTask, self).save_valid_result(sample, batch_idx, model_out)
